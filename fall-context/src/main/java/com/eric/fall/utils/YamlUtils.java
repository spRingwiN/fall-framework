...
public class YamlUtils {
    ...
    public static Map<String, Object> loadYaml(String path) {
        ...
        var resolver = new NoImplictResolver();
    ...
    static void convertTo(Map<String, Object> source, String prefix,
...
class NoImplictResolver extends Resolver {
    public NoImplictResolver() {
        super();
